...
f_iir_yline_filter(DSTTYPE *src, DSTTYPE *dest, int sx, int sy, double *filter)
{
	...
	uplusbuf = reinterpret_cast<double*>(malloc(sx * sizeof(*uplusbuf)));

	buf0 = reinterpret_cast<double*>(malloc(sx * sizeof(*buf0)));
	buf1 = reinterpret_cast<double*>(malloc(sx * sizeof(*buf1)));
	buf2 = reinterpret_cast<double*>(malloc(sx * sizeof(*buf2)));
	buf3 = reinterpret_cast<double*>(malloc(sx * sizeof(*buf3)));
	...
	double *filter, double tanp)
{
	...
	buf0 = reinterpret_cast<double*>(malloc((sx + sy * tanp + 2) * sizeof(*buf0)));
	buf1 = reinterpret_cast<double*>(malloc((sx + sy * tanp + 2) * sizeof(*buf1)));
	buf2 = reinterpret_cast<double*>(malloc((sx + sy * tanp + 2) * sizeof(*buf2)));
	buf3 = reinterpret_cast<double*>(malloc((sx + sy * tanp + 2) * sizeof(*buf3)));
	...
	double phi, int order)
{
	...
	buf = reinterpret_cast<double*>(malloc(sx * sizeof(*buf)));
